...
class JournalMessageScreen extends StatefulWidget {
  const JournalMessageScreen(Key key, {this.month = 0, this.day = 0})
      : super(key: key);
  final int month;
  final int day;

  @override
  State<StatefulWidget> createState() => _JournalMessageScreen();
}

class _JournalMessageScreen extends State<JournalMessageScreen> {
  final key = GlobalKey();
