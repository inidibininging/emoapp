...
import 'package:emoapp/model/discussion_message.dart';
import 'package:emoapp/model/entity_base_container_same.dart';
...
class ServiceLocatorRegistrar {
  ...
  Future<void> registerProfile() async {
    ...
    registerEntityInvocatorWithParams<Profile,
        (String name, String imageKey, String description, String currentDiscussionId)>(
      ((String name, String imageKey, String description, String currentDiscussionId) params) => Profile(
        id: const Uuid().v4(),
        name: params.$1,
        imageKey: params.$2,
    ...
    final profile = GetIt.instance
        .registerSingleton<EntityService<Profile, ProfileAdapter>>(
      EntityService<Profile, ProfileAdapter>(
        ProfileAdapter(),
        profileValidation,
      ),
    );
    ...
    final debugProfile = await profile.create(
      getSpecificEntityInstance<Profile,
          (String name, String imageKey, String description, String curentDiscussionId)>(
        'profile-box',
  ...
  Future<void> registerDiscussion() async {
    ...
    final discussion = GetIt.instance
        .registerSingleton<EntityService<Discussion, DiscussionAdapter>>(
      EntityService<Discussion, DiscussionAdapter>(
        DiscussionAdapter(),
    ...
    final discussionMessages = GetIt.instance.registerSingleton<
            EntityService<DiscussionMessage, DiscussionMessageAdapter>>(
        EntityService<DiscussionMessage, DiscussionMessageAdapter>(
      DiscussionMessageAdapter(),
      discussionMessageValidation,
    ));
