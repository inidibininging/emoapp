...
class JournalEntryExtendedService
  ...
  JournalEntryExtendedService(super.entityValidation, super.sdb);
}
// class JournalEntryExtendedService {
...
//     final currentProfileSvc = GetIt.instance.get<SqfEntityService<Profile>>();
